...
export interface ISystemSettingsInterface extends Interface {
...
export interface ISystemSettings extends BaseContract {
  connect(runner?: ContractRunner | null): ISystemSettings;
